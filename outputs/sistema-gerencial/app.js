...
function printBankAvailabilityVerticalReport() {
  ...
  popup.document.head?.insertAdjacentHTML("beforeend", `<style>
    ...
    .page{overflow:hidden;border:1px solid #d6e1e8;border-radius:4px;box-shadow:0 18px 50px rgba(15,39,65,.16)}
    .head{margin:-15mm -15mm 0;padding:12mm 15mm;background:linear-gradient(120deg,#213f68 0%,#154c5b 70%,#17685e 100%);border:0;color:#fff}
    .head img{width:138px;padding:9px 13px;border-radius:9px;background:#fff;box-shadow:0 7px 22px rgba(5,22,42,.22)}
    .head h1{color:#fff;font-size:25px;letter-spacing:-.02em}.head p{color:#c8dbe3}
    .summary{margin-top:17px;border:1px solid #4abda6;background:linear-gradient(90deg,#193c61,#17645d);box-shadow:0 8px 20px rgba(18,68,83,.15)}
    .summary span{letter-spacing:.025em}.summary strong{color:#78f0d5}
    .summary:has(.negative){border-color:#cf7884;background:linear-gradient(90deg,#653343,#8b3441)}.summary:has(.negative) strong{color:#ffd7dc!important}
