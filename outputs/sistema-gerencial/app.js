...
function normalizeCommercialAgendaTime(value) {
  ...
  if (!match) return "";
  let hours = Number(match[1]); const minutes = Number(match[2] || 0); const period = match[3] || "";
